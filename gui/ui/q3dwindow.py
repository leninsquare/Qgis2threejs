...
class Ui_Q3DWindow(object):
    def setupUi(self, Q3DWindow):
        ...
        self.actionSaveAsSTL = QtWidgets.QAction(parent=Q3DWindow)
        self.actionSaveAsSTL.setEnabled(False)
        self.actionSaveAsSTL.setObjectName("actionSaveAsSTL")
        self.actionSceneSettings = QtWidgets.QAction(parent=Q3DWindow)
        self.actionSceneSettings.setObjectName("actionSceneSettings")
        self.actionPerspective = QtWidgets.QAction(parent=Q3DWindow)
        ...
        self.actionOrthographic = QtWidgets.QAction(parent=Q3DWindow)
        self.actionOrthographic.setCheckable(True)
        self.actionOrthographic.setObjectName("actionOrthographic")
        self.actionReload = QtWidgets.QAction(parent=Q3DWindow)
        self.actionReload.setObjectName("actionReload")
        self.actionAlwaysOnTop = QtWidgets.QAction(parent=Q3DWindow)
        ...
        self.actionExportToWeb = QtWidgets.QAction(parent=Q3DWindow)
        self.actionExportToWeb.setEnabled(True)
        self.actionExportToWeb.setObjectName("actionExportToWeb")
        self.actionSaveAsImage = QtWidgets.QAction(parent=Q3DWindow)
        self.actionSaveAsImage.setObjectName("actionSaveAsImage")
        self.actionResetCameraPosition = QtWidgets.QAction(parent=Q3DWindow)
        self.actionResetCameraPosition.setObjectName("actionResetCameraPosition")
        self.actionCameraPosition = QtWidgets.QAction(parent=Q3DWindow)
        self.actionCameraPosition.setObjectName("actionCameraPosition")
        self.actionScreenshotSeries = QtWidgets.QAction(parent=Q3DWindow)
        self.actionScreenshotSeries.setObjectName("actionScreenshotSeries")
        self.actionLayer_Panel = QtWidgets.QAction(parent=Q3DWindow)
        ...
        self.actionClose = QtWidgets.QAction(parent=Q3DWindow)
        self.actionClose.setObjectName("actionClose")
        self.actionPluginSettings = QtWidgets.QAction(parent=Q3DWindow)
        self.actionPluginSettings.setObjectName("actionPluginSettings")
        self.actionHelp = QtWidgets.QAction(parent=Q3DWindow)
        self.actionHelp.setObjectName("actionHelp")
        self.actionHomePage = QtWidgets.QAction(parent=Q3DWindow)
        self.actionHomePage.setObjectName("actionHomePage")
        self.actionSendFeedback = QtWidgets.QAction(parent=Q3DWindow)
        self.actionSendFeedback.setObjectName("actionSendFeedback")
        self.actionVersion = QtWidgets.QAction(parent=Q3DWindow)
        self.actionVersion.setObjectName("actionVersion")
        self.actionSaveAsOBJ = QtWidgets.QAction(parent=Q3DWindow)
        self.actionSaveAsOBJ.setEnabled(False)
        self.actionSaveAsOBJ.setObjectName("actionSaveAsOBJ")
        self.actionSaveAsGLTF = QtWidgets.QAction(parent=Q3DWindow)
        self.actionSaveAsGLTF.setObjectName("actionSaveAsGLTF")
        self.actionClearSettings = QtWidgets.QAction(parent=Q3DWindow)
        self.actionClearSettings.setObjectName("actionClearSettings")
        self.actionNorthArrow = QtWidgets.QAction(parent=Q3DWindow)
        self.actionNorthArrow.setObjectName("actionNorthArrow")
        self.actionHeaderFooterLabel = QtWidgets.QAction(parent=Q3DWindow)
        self.actionHeaderFooterLabel.setObjectName("actionHeaderFooterLabel")
        self.actionSaveSettings = QtWidgets.QAction(parent=Q3DWindow)
        self.actionSaveSettings.setObjectName("actionSaveSettings")
        self.actionLoadSettings = QtWidgets.QAction(parent=Q3DWindow)
        self.actionLoadSettings.setObjectName("actionLoadSettings")
        self.actionAddPointCloudLayer = QtWidgets.QAction(parent=Q3DWindow)
        self.actionAddPointCloudLayer.setObjectName("actionAddPointCloudLayer")
        self.actionNavigationWidget = QtWidgets.QAction(parent=Q3DWindow)
        self.actionNavigationWidget.setCheckable(True)
        self.actionNavigationWidget.setObjectName("actionNavigationWidget")
        self.actionAddPlane = QtWidgets.QAction(parent=Q3DWindow)
        self.actionAddPlane.setObjectName("actionAddPlane")
        self.actionUsage = QtWidgets.QAction(parent=Q3DWindow)
        self.actionUsage.setObjectName("actionUsage")
        self.actionDevTools = QtWidgets.QAction(parent=Q3DWindow)
        ...
        self.menuCamera.addAction(self.actionCameraPosition)
        self.menuCamera.addAction(self.actionScreenshotSeries)
    ...
    def retranslateUi(self, Q3DWindow):
        ...
        self.actionCameraPosition.setText(_translate("Q3DWindow", "Camera Position..."))
        self.actionScreenshotSeries.setText(_translate("Q3DWindow", "Screenshot Series..."))
